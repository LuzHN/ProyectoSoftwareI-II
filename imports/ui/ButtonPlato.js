...
class ButtonPlato extends Component {
  ...
  loadNutritionalFacts() { //carga los nutritional facts del platillo
    ...
    $('#TotalSatFat').text(parseInt(this.state.plato.nutritionFacts.saturatedFat));
    $('#CholesterolPercentage').text(parseFloat((parseInt(this.props.plato.nutritionFacts.cholesterol) / 300.0) * 100).toFixed(1));
    $('#TotalCholesterol').text(parseInt(this.state.plato.nutritionFacts.cholesterol));
    ...
    $('#TotalCarbs').text(parseInt(this.state.plato.nutritionFacts.totalCarbohydrates));
    $('#DietaryFiberPercentage').text(parseFloat((parseInt(this.props.plato.nutritionFacts.dietaryFibers) / 25.0) * 100).toFixed(1));
    $('#TotalDietaryFiber').text(parseInt(this.state.plato.nutritionFacts.dietaryFibers));
    ...
    $('#TotalVitaminA').text(parseInt(this.state.plato.nutritionFacts.vitaminA));
    $('#VitaminCPercentage').text(parseFloat((parseInt(this.props.plato.nutritionFacts.vitaminC) / 60.0) * 100).toFixed(1));
    $('#TotalVitaminC').text(parseInt(this.state.plato.nutritionFacts.vitaminC));
    ...
    $('#TotalCalories').text(parseInt(this.state.plato.nutritionFacts.calories));
