...
import '../client/styles/editEmpleado.css';
        ...
        <div className="containerPrincipal">
          <div className="Buttons">
            <button
              ...
              onClick={this.onAgregar.bind(this)}
            >
              Agregar Empleado
            </button>
            <button
              className="botonModificar"
              onClick={this.onModificar.bind(this)}
            >
              Modificar
            </button>
          </div>
            ...
            <div className="modal-content">
              ...
              <div className="modal-header">
                <div className="modal-header-Btn">
                  <span
                    className="closeBtn"
                    onClick={this.closeModificar.bind(this)}
                  >
                    &times;
                  </span>
                </div>
                      ...
                      <div className="box1">
                        <p>
                          ...
                          <input
                            ref="oldPassword"
                            type="password"
                            placeholder="Ingrese la contraseña vieja."
                          />
                          <label>Confirmar Contraseña</label>
                          <input
                            ref="confirmPassword"
